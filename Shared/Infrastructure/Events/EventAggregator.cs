...
namespace Shared.Infrastructure.Events
{
    ...
    public class EventAggregator : IEventAggregator
    {
        ...
        {
            [Obsolete("Use constructor injection for IEventAggregator instead of the static Current instance.")]
            get => _current ?? throw new InvalidOperationException("EventAggregator.Current has not been initialized. Prefer injecting IEventAggregator.");
            [Obsolete("Use constructor injection for IEventAggregator instead of the static Current instance.")]
            set => _current = value;
        }
