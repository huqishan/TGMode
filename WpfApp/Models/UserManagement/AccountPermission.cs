...
public sealed class AccountPermissionProfile : INotifyPropertyChanged
{
    ...
    [JsonIgnore]
    public string DisplayName => $"{Name}（{LevelDisplayName}）";
...
public sealed class AccountPermissionOption
{
